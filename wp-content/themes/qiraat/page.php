...
$page_layout_meta = Qiraat_Group_Fields_Value::page_layout('qiraat');
$page_container_meta = Qiraat_Group_Fields_Value::page_container('qiraat','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area qiraat-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
