...
class Qiraat_Breadcrumb {
	/**
	 * Array of bread Qiraat_Breadcrumb
	 *
	 * @var array
	 */
	...
	public function __construct( array $options = [] ) {
		...
		$this->defaults['home'] = esc_html__('Home','qiraat');
		$this->defaults['blog'] = esc_html__('Blog','qiraat');
	...
	public function theBreadcrumbs() {
		...
		foreach ( $breadcrumbs as $crumb ) {
			...
			if ( $crumb['url'] ) {
                ...
                $html .= sprintf( '<span>%s</span>', wp_kses($crumb['title'],qiraat()->kses_allowed_html('all')) );
			}
		...
		echo wp_kses($html,qiraat()->kses_allowed_html('all'));
	}
	...
	public function getBreadcrumbs() {
		...
		$breadcrumbs = apply_filters( 'qiraat_get_breadcrumbs', $breadcrumbs );
 ...
 * Template Functions.
 */
if ( ! function_exists( 'qiraat_breadcrumb' ) ) {
	/**
	 ...
	 * @package qiraat
	 */
	function qiraat_breadcrumb( $options = [] ) {
		$Crumbs = new Qiraat_Breadcrumb( $options );
		$Crumbs->theBreadcrumbs();
	}
}

if ( ! function_exists( 'qiraat_get_breadcrumbs' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qiraat_get_breadcrumbs( $options = [] ) {
		$Crumbs = new Qiraat_Breadcrumb( $options );
 ...
 * Utility functions
 */
if ( ! function_exists( 'qiraat_breadcrumb_array_insert' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qiraat_breadcrumb_array_insert( array $array, $element, int $position ) {
