 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme qiraat for publication on ThemeForest
...
add_action( 'tgmpa_register', 'qiraat_register_required_plugins' );
 ...
 */
function qiraat_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            'name'         => 'Qiraat Core',
            'slug'         => 'qiraat-core',
            'source'       => 'https://themeim.com/plugins/qiraat/qiraat-core.zip',
            'required'     => true,
            'version'      => '1.0.0',
