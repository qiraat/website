...
function import_files()
{
    return [
        [
            'import_file_name'           => 'Qiraat',
            'categories'                   => 'qiraat',
            'local_import_file'            => trailingslashit(QIRAAT_CORE_ROOT_PATH) . 'demo-import/demo-data/content.xml',
            'local_import_customizer_file'     => trailingslashit(QIRAAT_CORE_ROOT_PATH) . 'demo-import/demo-data/customize.dat',
            'local_import_widget_file'     => trailingslashit(QIRAAT_CORE_ROOT_PATH) . 'demo-import/demo-data/widgets.wie',
            'local_import_json' => array(
                array(
                    'file_path'     => trailingslashit(QIRAAT_CORE_ROOT_PATH) . 'demo-import/demo-data/theme-settings.json',
                    'option_name'   => 'qiraat_theme_options',
                ),
            ),
            ...
            'preview_url'   => 'https://themeim.com/wp/qiraat',
            'import_preview_image_url' => QIRAAT_CORE_ROOT_URL .'demo-import/demo-data/images/main-demo.jpg'
        ],
        array(
            'import_file_name'           => 'Qiraat RTL',
            'local_import_file'            => trailingslashit( QIRAAT_CORE_ROOT_PATH ) . 'demo-import/demo-data/content-rtl.xml',
            'import_notice' => esc_html__( 'Please Give Some Time To Import Theme Demo Data, It May Take 5-10 Minutes, It Will Download All Theme Data From Server So Be Cool!.', 'appside-master' ),
            'preview_url'   => 'https://themeim.com/wp/qiraat/rtl',
            'import_preview_image_url' => QIRAAT_CORE_ROOT_URL .'demo-import/demo-data/images/main-demo-rtl.jpg'
        ),
    ];
}
