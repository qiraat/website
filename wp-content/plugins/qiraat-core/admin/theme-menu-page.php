...
if (!class_exists('Qiraat_Core_Admin_Menu')) {

    class Qiraat_Core_Admin_Menu
    {
       /**
        * $instance
        * @since 1.0.0
        ...
        */
        ...
        public function theme_admin_menu_page()
        {
            ...
            //add menu page
            add_menu_page(
                esc_html__('Qiraat Page', 'qiraat-core'),
                esc_html__('Qiraat', 'qiraat-core'),
                'manage_options',
                'qiraat_theme_options',
                array($this, 'admin_options_fallback_function'),
                QIRAAT_CORE_ADMIN_ASSETS . '/img/icon.png',
                80
            );
        }
        ...
        public function admin_menu_activation()
        {
            ...
            <script type="text/javascript">
                (function ($) {
                    ...
                    mainwrap = $('#toplevel_page_qiraat_theme_options');
                    ...
                    if (check) {
                        $('.wp-submenu.wp-submenu-wrap')
                            .find('a[href*="admin.php?page=toplevel_page_qiraat_theme_options"]')
                            .removeClass('current')
                            .parent('li')
                            .removeClass('current');
                    }
    ...
    if (class_exists('Qiraat_Core_Admin_Menu')) {
        Qiraat_Core_Admin_Menu::getInstance();
    }
